...
await page.waitForTimeout(12000); // impact + settle
// crank the aftermath throttle 5× (⏩⏩⏩⏩⏩)
for (let i = 0; i < 5; i++) await page.click('text=⏩ faster');
await page.waitForTimeout(30000);
await page.screenshot({ path: `${out}/f1-late.png` });
await page.waitForTimeout(30000);
await page.screenshot({ path: `${out}/f2-later.png` });
